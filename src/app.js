...
import UsersRouter from './routers/users.router.js'; // 사용자 
import PostsRouter from './routes/posts.router.js'; // 게시글 생성 API 비즈니스
import CommentsRouter from './routes/comments.router.js'; // 게시판 댓글 생성 
dotenv.config();
...
app.use('/api', [UsersRouter, PostsRouter, CommentsRouter]); // 사용자, 게시글 생성, 댓글 생성
